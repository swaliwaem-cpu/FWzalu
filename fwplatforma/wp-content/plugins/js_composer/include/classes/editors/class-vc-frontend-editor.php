...
class Vc_Frontend_Editor extends Vc_Editor {
	...
	public function registerJs() {
		...
		wp_register_script( 'select2', vc_asset_url( 'lib/vendor/node_modules/select2/dist/js/select2.min.js' ), array(), WPB_VC_VERSION, true );
	...
	public function registerCss() {
		...
		wp_register_style( 'select2', vc_asset_url( 'lib/vendor/node_modules/select2/dist/css/select2.min.css' ), array(), WPB_VC_VERSION, false );
