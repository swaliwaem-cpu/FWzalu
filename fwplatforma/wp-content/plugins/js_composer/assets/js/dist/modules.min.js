...
["wpbAceEditorContentChanged","wpbPageSettingRollBack"].forEach(function(e){document.addEventListener(e,function(e){var t;vc.frame_window&&(e.detail.wpb_js_header_editor&&(t=e.detail.wpb_js_header_editor.currentValue,vc.frame_window.vc_iframe.loadCustomJsHeader(t)),e.detail.wpb_js_footer_editor)&&(t=e.detail.wpb_js_footer_editor.currentValue,vc.frame_window.vc_iframe.loadCustomJsFooter(t))})});
["wpbAceEditorContentChanged","wpbPageSettingRollBack"].forEach(function(e){document.addEventListener(e,function(e){e.detail.wpb_css_editor&&(e=e.detail.wpb_css_editor.currentValue,vc.frame_window)&&vc.frame_window.vc_iframe.loadCustomCss(e)})});